...
- Prefer the simplest clean implementation that serves the requested feature on PostgreSQL and Supabase. If a change is only useful for hypothetical portability or an unrelated future feature, leave it out and note it as a separate product decision instead.
